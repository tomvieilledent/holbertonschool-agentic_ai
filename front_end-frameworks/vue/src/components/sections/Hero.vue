...
<template>
  <section id="hero-section" class="relative overflow-hidden bg-black pt-36 pb-24">
    ...
    <div class="pointer-events-none absolute inset-0">
      ...
      />
      <!-- Radial blue glow -->
      <div class="absolute top-40 right-1/4 h-120 w-120 rounded-full bg-blue-500/10 blur-3xl" />
      <!-- Grid overlay -->
      <div
      ...
      />
      <!-- Depth vignette -->
      <div class="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-slate-950" />
    </div>

    <div
      class="relative mx-auto flex w-full max-w-6xl flex-col items-center gap-8 px-6 text-center"
    >
      <!-- Badge -->
      ...
      <div class="flex flex-col items-center gap-4 sm:flex-row">
        ...
        <Button
          ...
          variant="secondary"
          class="text-sm whitespace-nowrap md:text-base"
        >
          Methodology
        </Button>
      </div>
